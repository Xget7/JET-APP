...
import xget.dev.jet.core.utils.ConstantsShared.ConnectionStatusProperty
import xget.dev.jet.core.utils.ConstantsShared.historyProperty
import xget.dev.jet.data.local.db.AppDatabase
import xget.dev.jet.data.local.entity.ConnectionEntity
import xget.dev.jet.data.local.entity.utils.toSubscriptionEntity
...
class Connection private constructor(
    ...
    fun addHistory(action: String) {
        ...
        notifyListeners(PropertyChangeEvent(this, historyProperty, null, null))
    }
    ...
    fun changeConnectionStatus(connectionStatus: ConnectionStatus) {
        ...
        notifyListeners(PropertyChangeEvent(this, ConnectionStatusProperty, null, null))
    }
    ...
    companion object {
        ...
        fun createConnection(
            ...
            val foregroundNotification = Notify.foregroundNotification(context, clientId, intent, R.string.notifyTitle)
